...
# This program is designed to read all of the video URLS from a youtube playlist page. It then writes them to an xspf
# file, which is what is used by the open source software VLC as playlist files.
